...
<div class="menuall">
	<ul>
		...
		|
		<li>
			<a href="javascript:;" class="menu1" id="Community"> Community </a>
		</li>
		|
		<li>
			<a href="javascript:;" class="menu1" id="Mypage"> Mypage </a>
		</li>
		|
		<li>
		...
		|
		<li>
			<a href="javascript:;" class="menu1" id="More"> More </a>
		</li>
	</ul>
<hr />
</div>
